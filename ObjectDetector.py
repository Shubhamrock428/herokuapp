...
class Detector:
    ...
    def detectObject(self, imName):
        img = cv2.cvtColor(cv2.imread(numpy.array(imName), cv2.COLOR_BGR2RGB))
        cv2Net.setInput(cv2.dnn.blobFromImage(img, 0.007843, (600,1024), (127.5, 127.5, 127.5),swapRB=True, crop=False))
