...
class Detector:
    ...
    def detectObject(self, imName):
        ...
        #img = cv.imread(numpy.array["imame"], cv.IMREAD_GRAYSCALE)
        cvNet.setInput(cv.dnn.blobFromImage(img,0.007843, cv.resize(img,(300, 300)), (127.5, 127.5, 127.5),swapRB=True, crop=False))
